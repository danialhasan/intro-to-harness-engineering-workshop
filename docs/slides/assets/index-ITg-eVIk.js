...
`+i))});const n=document.querySelector("head");n.insertBefore(e,n.lastChild)};class Ln{constructor(t){this.Reveal=t,this.state="idle",this.registeredPlugins={},this.asyncDependencies=[]}load(t,e){return this.state="loading",t.forEach(this.registerPlugin.bind(this)),new Promise((n=>{let i=[],s=0;if(e.forEach((a=>{a.condition&&!a.condition()||(a.async?this.asyncDependencies.push(a):i.push(a))})),i.length){s=i.length;const a=o=>{o&&typeof o.callback=="function"&&o.callback(),--s==0&&this.initPlugins().then(n)};i.forEach((o=>{typeof o.id=="string"?(this.registerPlugin(o),a(o)):typeof o.src=="string"?_e(o.src,(()=>a(o))):(console.warn("Unrecognized plugin format",o),a())}))}else this.initPlugins().then(n)}))}initPlugins(){return new Promise((t=>{let e=Object.values(this.registeredPlugins),n=e.length;if(n===0)this.loadAsync().then(t);else{let i,s=()=>{--n==0?this.loadAsync().then(t):i()},a=0;i=()=>{let o=e[a++];if(typeof o.init=="function"){let r=o.init(this.Reveal);r&&typeof r.then=="function"?r.then(s):s()}else s()},i()}}))}loadAsync(){return this.state="loaded",this.asyncDependencies.length&&this.asyncDependencies.forEach((t=>{_e(t.src,t.callback)})),Promise.resolve()}registerPlugin(t){arguments.length===2&&typeof arguments[0]=="string"?(t=arguments[1]).id=arguments[0]:typeof t=="function"&&(t=t());let e=t.id;typeof e!="string"?console.warn("Unrecognized plugin format; can't find plugin.id",t):this.registeredPlugins[e]===void 0?(this.registeredPlugins[e]=t,this.state==="loaded"&&typeof t.init=="function"&&t.init(this.Reveal)):console.warn('reveal.js: "'+e+'" plugin has already been registered')}hasPlugin(t){return!!this.registeredPlugins[t]}getPlugin(t){return this.registeredPlugins[t]}getRegisteredPlugins(){return this.registeredPlugins}destroy(){Object.values(this.registeredPlugins).forEach((t=>{typeof t.destroy=="function"&&t.destroy()})),this.registeredPlugins={},this.asyncDependencies=[]}}class Tn{constructor(t){this.Reveal=t,this.onSlidesClicked=this.onSlidesClicked.bind(this),this.iframeTriggerSelector=null,this.mediaTriggerSelector="[data-preview-image], [data-preview-video]",this.stateProps=["previewIframe","previewImage","previewVideo","previewFit"],this.state={}}update(){this.Reveal.getConfig().previewLinks?this.iframeTriggerSelector="a[href]:not([data-preview-link=false]), [data-preview-link]:not(a):not([data-preview-link=false])":this.iframeTriggerSelector="[data-preview-link]:not([data-preview-link=false])";const t=this.Reveal.getSlidesElement().querySelectorAll(this.iframeTriggerSelector).length>0,e=this.Reveal.getSlidesElement().querySelectorAll(this.mediaTriggerSelector).length>0;t||e?this.Reveal.getSlidesElement().addEventListener("click",this.onSlidesClicked,!1):this.Reveal.getSlidesElement().removeEventListener("click",this.onSlidesClicked,!1)}createOverlay(t){this.dom=document.createElement("div"),this.dom.classList.add("r-overlay"),this.dom.classList.add(t),this.viewport=document.createElement("div"),this.viewport.classList.add("r-overlay-viewport"),this.dom.appendChild(this.viewport),this.Reveal.getRevealElement().appendChild(this.dom)}previewIframe(t){this.close(),this.state={previewIframe:t},this.createOverlay("r-overlay-preview"),this.dom.dataset.state="loading",this.viewport.innerHTML=`<header class="r-overlay-header">
			...
			`,this.dom.querySelector(".r-overlay-close").addEventListener("click",(i=>{this.close(),i.preventDefault()}),!1),this.Reveal.dispatchEvent({type:"showhelp"})}}isOpen(){return!!this.dom}close(){return!!this.dom&&(this.dom.remove(),this.dom=null,this.state={},this.Reveal.dispatchEvent({type:"closeoverlay"}),!0)}getState(){return this.state}setState(t){this.stateProps.every((e=>this.state[e]===t[e]))||(t.previewIframe?this.previewIframe(t.previewIframe):t.previewImage?this.previewImage(t.previewImage,t.previewFit):t.previewVideo?this.previewVideo(t.previewVideo,t.previewFit):this.close())}onSlidesClicked(t){const e=t.target,n=e.closest(this.iframeTriggerSelector),i=e.closest(this.mediaTriggerSelector);if(n){if(t.metaKey||t.shiftKey||t.altKey)return;let s=n.getAttribute("href")||n.getAttribute("data-preview-link");s&&(this.previewIframe(s),t.preventDefault())}else if(i){if(i.hasAttribute("data-preview-image")){let s=i.dataset.previewImage||i.getAttribute("src");s&&(this.previewImage(s,i.dataset.previewFit),t.preventDefault())}else if(i.hasAttribute("data-preview-video")){let s=i.dataset.previewVideo||i.getAttribute("src");if(!s){let a=i.querySelector("source");a&&(s=a.getAttribute("src"))}s&&(this.previewVideo(s,i.dataset.previewFit),t.preventDefault())}}}destroy(){this.close()}}let Cn=class{constructor(t){this.Reveal=t,this.touchStartX=0,this.touchStartY=0,this.touchStartCount=0,this.touchCaptured=!1,this.onPointerDown=this.onPointerDown.bind(this),this.onPointerMove=this.onPointerMove.bind(this),this.onPointerUp=this.onPointerUp.bind(this),this.onTouchStart=this.onTouchStart.bind(this),this.onTouchMove=this.onTouchMove.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this)}bind(){let t=this.Reveal.getRevealElement();"onpointerdown"in window?(t.addEventListener("pointerdown",this.onPointerDown,!1),t.addEventListener("pointermove",this.onPointerMove,!1),t.addEventListener("pointerup",this.onPointerUp,!1)):window.navigator.msPointerEnabled?(t.addEventListener("MSPointerDown",this.onPointerDown,!1),t.addEventListener("MSPointerMove",this.onPointerMove,!1),t.addEventListener("MSPointerUp",this.onPointerUp,!1)):(t.addEventListener("touchstart",this.onTouchStart,!1),t.addEventListener("touchmove",this.onTouchMove,!1),t.addEventListener("touchend",this.onTouchEnd,!1))}unbind(){let t=this.Reveal.getRevealElement();t.removeEventListener("pointerdown",this.onPointerDown,!1),t.removeEventListener("pointermove",this.onPointerMove,!1),t.removeEventListener("pointerup",this.onPointerUp,!1),t.removeEventListener("MSPointerDown",this.onPointerDown,!1),t.removeEventListener("MSPointerMove",this.onPointerMove,!1),t.removeEventListener("MSPointerUp",this.onPointerUp,!1),t.removeEventListener("touchstart",this.onTouchStart,!1),t.removeEventListener("touchmove",this.onTouchMove,!1),t.removeEventListener("touchend",this.onTouchEnd,!1)}isSwipePrevented(t){if($t(t,"video[controls], audio[controls]"))return!0;for(;t&&typeof t.hasAttribute=="function";){if(t.hasAttribute("data-prevent-swipe"))return!0;t=t.parentNode}return!1}onTouchStart(t){if(this.touchCaptured=!1,this.isSwipePrevented(t.target))return!0;this.touchStartX=t.touches[0].clientX,this.touchStartY=t.touches[0].clientY,this.touchStartCount=t.touches.length}onTouchMove(t){if(this.isSwipePrevented(t.target))return!0;let e=this.Reveal.getConfig();if(this.touchCaptured)Je&&t.preventDefault();else{this.Reveal.onUserInput(t);let n=t.touches[0].clientX,i=t.touches[0].clientY;if(t.touches.length===1&&this.touchStartCount!==2){let s=this.Reveal.availableRoutes({includeFragments:!0}),a=n-this.touchStartX,o=i-this.touchStartY;a>40&&Math.abs(a)>Math.abs(o)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.next():this.Reveal.prev():this.Reveal.left()):a<-40&&Math.abs(a)>Math.abs(o)?(this.touchCaptured=!0,e.navigationMode==="linear"?e.rtl?this.Reveal.prev():this.Reveal.next():this.Reveal.right()):o>40&&s.up?(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.prev():this.Reveal.up()):o<-40&&s.down&&(this.touchCaptured=!0,e.navigationMode==="linear"?this.Reveal.next():this.Reveal.down()),e.embedded?(this.touchCaptured||this.Reveal.isVerticalSlide())&&t.preventDefault():t.preventDefault()}}}onTouchEnd(t){this.touchCaptured=!1}onPointerDown(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchStart(t))}onPointerMove(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchMove(t))}onPointerUp(t){t.pointerType!==t.MSPOINTER_TYPE_TOUCH&&t.pointerType!=="touch"||(t.touches=[{clientX:t.clientX,clientY:t.clientY}],this.onTouchEnd(t))}};const Jt="focus",De="blur";class Pn{constructor(t){this.Reveal=t,this.onRevealPointerDown=this.onRevealPointerDown.bind(this),this.onDocumentPointerDown=this.onDocumentPointerDown.bind(this)}configure(t,e){t.embedded?this.blur():(this.focus(),this.unbind())}bind(){this.Reveal.getConfig().embedded&&this.Reveal.getRevealElement().addEventListener("pointerdown",this.onRevealPointerDown,!1)}unbind(){this.Reveal.getRevealElement().removeEventListener("pointerdown",this.onRevealPointerDown,!1),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)}focus(){this.state!==Jt&&(this.Reveal.getRevealElement().classList.add("focused"),document.addEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=Jt}blur(){this.state!==De&&(this.Reveal.getRevealElement().classList.remove("focused"),document.removeEventListener("pointerdown",this.onDocumentPointerDown,!1)),this.state=De}isFocused(){return this.state===Jt}destroy(){this.Reveal.getRevealElement().classList.remove("focused")}onRevealPointerDown(t){this.focus()}onDocumentPointerDown(t){let e=W(t.target,".reveal");e&&e===this.Reveal.getRevealElement()||this.blur()}}class In{constructor(t){this.Reveal=t}render(){this.element=document.createElement("div"),this.element.className="speaker-notes",this.element.setAttribute("data-prevent-swipe",""),this.element.setAttribute("tabindex","0"),this.Reveal.getRevealElement().appendChild(this.element)}configure(t,e){t.showNotes&&this.element.setAttribute("data-layout",typeof t.showNotes=="string"?t.showNotes:"inline")}update(){this.Reveal.getConfig().showNotes&&this.element&&this.Reveal.getCurrentSlide()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()&&(this.element.innerHTML=this.getSlideNotes()||'<span class="notes-placeholder">No notes on this slide.</span>')}updateVisibility(){this.Reveal.getConfig().showNotes&&this.hasNotes()&&!this.Reveal.isScrollView()&&!this.Reveal.isPrintView()?this.Reveal.getRevealElement().classList.add("show-notes"):this.Reveal.getRevealElement().classList.remove("show-notes")}hasNotes(){return this.Reveal.getSlidesElement().querySelectorAll("[data-notes], aside.notes").length>0}isSpeakerNotesWindow(){return!!window.location.search.match(/receiver/gi)}getSlideNotes(t=this.Reveal.getCurrentSlide()){if(t.hasAttribute("data-notes"))return t.getAttribute("data-notes");let e=t.querySelectorAll("aside.notes");return e?Array.from(e).map((n=>n.innerHTML)).join(`
`):null}destroy(){this.element.remove()}}class Nn{constructor(t,e){this.diameter=100,this.diameter2=this.diameter/2,this.thickness=6,this.playing=!1,this.progress=0,this.progressOffset=1,this.container=t,this.progressCheck=e,this.canvas=document.createElement("canvas"),this.canvas.className="playback",this.canvas.width=this.diameter,this.canvas.height=this.diameter,this.canvas.style.width=this.diameter2+"px",this.canvas.style.height=this.diameter2+"px",this.context=this.canvas.getContext("2d"),this.container.appendChild(this.canvas),this.render()}setPlaying(t){const e=this.playing;this.playing=t,!e&&this.playing?this.animate():this.render()}animate(){const t=this.progress;this.progress=this.progressCheck(),t>.8&&this.progress<.2&&(this.progressOffset=this.progress),this.render(),this.playing&&requestAnimationFrame(this.animate.bind(this))}render(){let t=this.playing?this.progress:0,e=this.diameter2-this.thickness,n=this.diameter2,i=this.diameter2,s=28;this.progressOffset+=.1*(1-this.progressOffset);const a=-Math.PI/2+t*(2*Math.PI),o=-Math.PI/2+this.progressOffset*(2*Math.PI);this.context.save(),this.context.clearRect(0,0,this.diameter,this.diameter),this.context.beginPath(),this.context.arc(n,i,e+4,0,2*Math.PI,!1),this.context.fillStyle="rgba( 0, 0, 0, 0.4 )",this.context.fill(),this.context.beginPath(),this.context.arc(n,i,e,0,2*Math.PI,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="rgba( 255, 255, 255, 0.2 )",this.context.stroke(),this.playing&&(this.context.beginPath(),this.context.arc(n,i,e,o,a,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="#fff",this.context.stroke()),this.context.translate(n-14,i-14),this.playing?(this.context.fillStyle="#fff",this.context.fillRect(0,0,10,s),this.context.fillRect(18,0,10,s)):(this.context.beginPath(),this.context.translate(4,0),this.context.moveTo(0,0),this.context.lineTo(24,14),this.context.lineTo(0,s),this.context.fillStyle="#fff",this.context.fill()),this.context.restore()}on(t,e){this.canvas.addEventListener(t,e,!1)}off(t,e){this.canvas.removeEventListener(t,e,!1)}destroy(){this.playing=!1,this.canvas.parentNode&&this.container.removeChild(this.canvas)}}var Mn={width:960,height:700,margin:.04,minScale:.2,maxScale:2,controls:!0,controlsTutorial:!0,controlsLayout:"bottom-right",controlsBackArrows:"faded",progress:!0,slideNumber:!1,showSlideNumber:"all",hashOneBasedIndex:!1,hash:!1,respondToHashChanges:!0,jumpToSlide:!0,history:!1,keyboard:!0,keyboardCondition:null,disableLayout:!1,overview:!0,center:!0,touch:!0,loop:!1,rtl:!1,navigationMode:"default",shuffle:!1,fragments:!0,fragmentInURL:!0,embedded:!1,help:!0,pause:!0,showNotes:!1,showHiddenSlides:!1,autoPlayMedia:null,preloadIframes:null,autoAnimate:!0,autoAnimateMatcher:null,autoAnimateEasing:"ease",autoAnimateDuration:1,autoAnimateUnmatched:!0,autoAnimateStyles:["opacity","color","background-color","padding","font-size","line-height","letter-spacing","border-width","border-color","border-radius","outline","outline-offset"],autoSlide:0,autoSlideStoppable:!0,autoSlideMethod:null,defaultTiming:null,mouseWheel:!1,previewLinks:!1,postMessage:!0,postMessageEvents:!1,focusBodyOnPageVisibilityChange:!0,transition:"slide",transitionSpeed:"default",backgroundTransition:"fade",parallaxBackgroundImage:"",parallaxBackgroundSize:"",parallaxBackgroundRepeat:"",parallaxBackgroundPosition:"",parallaxBackgroundHorizontal:null,parallaxBackgroundVertical:null,view:null,scrollLayout:"full",scrollSnap:"mandatory",scrollProgress:"auto",scrollActivationWidth:435,pdfMaxPagesPerSlide:Number.POSITIVE_INFINITY,pdfSeparateFragments:!0,pdfPageHeightOffset:-1,viewDistance:3,mobileViewDistance:2,display:"block",hideInactiveCursor:!0,hideCursorTime:5e3,sortFragmentsOnSync:!0,dependencies:[],plugins:[]};const Ze="5.2.1";function Qe(c,t){arguments.length<2&&(t=arguments[0],c=document.querySelector(".reveal"));const e={};let n,i,s,a,o,r={},p=!1,u=!1,d={hasNavigatedHorizontally:!1,hasNavigatedVertically:!1},g=[],y=1,L={layout:"",overview:""},h={},D="idle",S=0,q=0,J=-1,M=!1,R=new un(e),T=new gn(e),O=new mn(e),U=new vn(e),N=new fn(e),f=new yn(e),C=new bn(e),P=new wn(e),$=new kn(e),K=new Sn(e),X=new En(e),V=new xn(e),nt=new An(e),ne=new Rn(e),tt=new Ln(e),F=new Tn(e),ht=new Pn(e),Ht=new Cn(e),G=new In(e);function on(){p!==!1&&(u=!0,r.showHiddenSlides||E(h.wrapper,'section[data-visibility="hidden"]').forEach((l=>{const m=l.parentNode;m.childElementCount===1&&/section/i.test(m.nodeName)?m.remove():l.remove()})),(function(){h.slides.classList.add("no-transition"),bt?h.wrapper.classList.add("no-hover"):h.wrapper.classList.remove("no-hover"),N.render(),T.render(),O.render(),V.render(),nt.render(),G.render(),h.pauseOverlay=((l,m,v,b="")=>{let w=l.querySelectorAll("."+v);for(let z=0;z<w.length;z++){let H=w[z];if(H.parentNode===l)return H}let I=document.createElement(m);return I.className=v,I.innerHTML=b,l.appendChild(I),I})(h.wrapper,"div","pause-overlay",r.controls?'<button class="resume-button">Resume presentation</button>':null),h.statusElement=(function(){let l=h.wrapper.querySelector(".aria-status");return l||(l=document.createElement("div"),l.style.position="absolute",l.style.height="1px",l.style.width="1px",l.style.overflow="hidden",l.style.clip="rect( 1px, 1px, 1px, 1px )",l.classList.add("aria-status"),l.setAttribute("aria-live","polite"),l.setAttribute("aria-atomic","true"),h.wrapper.appendChild(l)),l})(),h.wrapper.setAttribute("role","application")})(),r.postMessage&&window.addEventListener("message",Ce,!1),setInterval((()=>{(!f.isActive()&&h.wrapper.scrollTop!==0||h.wrapper.scrollLeft!==0)&&(h.wrapper.scrollTop=0,h.wrapper.scrollLeft=0)}),1e3),document.addEventListener("fullscreenchange",It),document.addEventListener("webkitfullscreenchange",It),at().forEach((l=>{E(l,"section").forEach(((m,v)=>{v>0&&(m.classList.remove("present"),m.classList.remove("past"),m.classList.add("future"),m.setAttribute("aria-hidden","true"))}))})),ie(),N.update(!0),(function(){const l=r.view==="print",m=r.view==="scroll"||r.view==="reader";(l||m)&&(l?xt():Ht.unbind(),h.viewport.classList.add("loading-scroll-mode"),l?document.readyState==="complete"?C.activate():window.addEventListener("load",(()=>C.activate())):f.activate())})(),X.readURL(),setTimeout((()=>{h.slides.classList.remove("no-transition"),h.wrapper.classList.add("ready"),Q({type:"ready",data:{indexh:n,indexv:i,currentSlide:a}})}),1))}function _t(l){h.statusElement.textContent=l}function Et(l){let m="";if(l.nodeType===3)m+=l.textContent;else if(l.nodeType===1){let v=l.getAttribute("aria-hidden"),b=window.getComputedStyle(l).display==="none";v==="true"||b||Array.from(l.childNodes).forEach((w=>{m+=Et(w)}))}return m=m.trim(),m===""?"":m+" "}function ie(l){const m={...r};if(typeof l=="object"&&yt(r,l),e.isReady()===!1)return;const v=h.wrapper.querySelectorAll(pt).length;h.wrapper.classList.remove(m.transition),h.wrapper.classList.add(r.transition),h.wrapper.setAttribute("data-transition-speed",r.transitionSpeed),h.wrapper.setAttribute("data-background-transition",r.backgroundTransition),h.viewport.style.setProperty("--slide-width",typeof r.width=="string"?r.width:r.width+"px"),h.viewport.style.setProperty("--slide-height",typeof r.height=="string"?r.height:r.height+"px"),r.shuffle&&Ft(),Xt(h.wrapper,"embedded",r.embedded),Xt(h.wrapper,"rtl",r.rtl),Xt(h.wrapper,"center",r.center),r.pause===!1&&kt(),U.reset(),o&&(o.destroy(),o=null),v>1&&r.autoSlide&&r.autoSlideStoppable&&(o=new Nn(h.wrapper,(()=>Math.min(Math.max((Date.now()-J)/S,0),1))),o.on("click",ln),M=!1),r.navigationMode!=="default"?h.wrapper.setAttribute("data-navigation-mode",r.navigationMode):h.wrapper.removeAttribute("data-navigation-mode"),G.configure(r,m),ht.configure(r,m),ne.configure(r,m),V.configure(r,m),nt.configure(r,m),K.configure(r,m),P.configure(r,m),T.configure(r,m),fe()}function se(){window.addEventListener("resize",Ne,!1),r.touch&&Ht.bind(),r.keyboard&&K.bind(),r.progress&&nt.bind(),r.respondToHashChanges&&X.bind(),V.bind(),ht.bind(),h.slides.addEventListener("click",Ie,!1),h.slides.addEventListener("transitionend",Pe,!1),h.pauseOverlay.addEventListener("click",kt,!1),r.focusBodyOnPageVisibilityChange&&document.addEventListener("visibilitychange",Me,!1)}function xt(){Ht.unbind(),ht.unbind(),K.unbind(),V.unbind(),nt.unbind(),X.unbind(),window.removeEventListener("resize",Ne,!1),h.slides.removeEventListener("click",Ie,!1),h.slides.removeEventListener("transitionend",Pe,!1),h.pauseOverlay.removeEventListener("click",kt,!1)}function ae(l,m,v){c.addEventListener(l,m,v)}function re(l,m,v){c.removeEventListener(l,m,v)}function Dt(l){typeof l.layout=="string"&&(L.layout=l.layout),typeof l.overview=="string"&&(L.overview=l.overview),L.layout?lt(h.slides,L.layout+" "+L.overview):lt(h.slides,L.overview)}function Q({target:l=h.wrapper,type:m,data:v,bubbles:b=!0}){let w=document.createEvent("HTMLEvents",1,2);return w.initEvent(m,b,!0),yt(w,v),l.dispatchEvent(w),l===h.wrapper&&le(m),w}function oe(l){Q({type:"slidechanged",data:{indexh:n,indexv:i,previousSlide:s,currentSlide:a,origin:l}})}function le(l,m){if(r.postMessageEvents&&window.parent!==window.self){let v={namespace:"reveal",eventName:l,state:Le()};yt(v,m),window.parent.postMessage(JSON.stringify(v),"*")}}function mt(){if(h.wrapper&&!C.isActive()){const l=h.viewport.offsetWidth,m=h.viewport.offsetHeight;if(!r.disableLayout){bt&&!r.embedded&&document.documentElement.style.setProperty("--vh",.01*window.innerHeight+"px");const v=f.isActive()?At(l,m):At(),b=y;ce(r.width,r.height),h.slides.style.width=v.width+"px",h.slides.style.height=v.height+"px",y=Math.min(v.presentationWidth/v.width,v.presentationHeight/v.height),y=Math.max(y,r.minScale),y=Math.min(y,r.maxScale),y===1||f.isActive()?(h.slides.style.zoom="",h.slides.style.left="",h.slides.style.top="",h.slides.style.bottom="",h.slides.style.right="",Dt({layout:""})):(h.slides.style.zoom="",h.slides.style.left="50%",h.slides.style.top="50%",h.slides.style.bottom="auto",h.slides.style.right="auto",Dt({layout:"translate(-50%, -50%) scale("+y+")"}));const w=Array.from(h.wrapper.querySelectorAll(pt));for(let I=0,z=w.length;I<z;I++){const H=w[I];H.style.display!=="none"&&(r.center||H.classList.contains("center")?H.classList.contains("stack")?H.style.top=0:H.style.top=Math.max((v.height-H.scrollHeight)/2,0)+"px":H.style.top="")}b!==y&&Q({type:"resize",data:{oldScale:b,scale:y,size:v}})}(function(){if(h.wrapper&&!r.disableLayout&&!C.isActive()&&typeof r.scrollActivationWidth=="number"&&r.view!=="scroll"){const v=At();v.presentationWidth>0&&v.presentationWidth<=r.scrollActivationWidth?f.isActive()||(N.create(),f.activate()):f.isActive()&&f.deactivate()}})(),h.viewport.style.setProperty("--slide-scale",y),h.viewport.style.setProperty("--viewport-width",l+"px"),h.viewport.style.setProperty("--viewport-height",m+"px"),f.layout(),nt.update(),N.updateParallax(),$.isActive()&&$.update()}}function ce(l,m){E(h.slides,"section > .stretch, section > .r-stretch").forEach((v=>{let b=((w,I=0)=>{if(w){let z,H=w.style.height;return w.style.height="0px",w.parentNode.style.height="auto",z=I-w.parentNode.offsetHeight,w.style.height=H+"px",w.parentNode.style.removeProperty("height"),z}return I})(v,m);if(/(img|video)/gi.test(v.nodeName)){const w=v.naturalWidth||v.videoWidth,I=v.naturalHeight||v.videoHeight,z=Math.min(l/w,b/I);v.style.width=w*z+"px",v.style.height=I*z+"px"}else v.style.width=l+"px",v.style.height=b+"px"}))}function At(l,m){let v=r.width,b=r.height;r.disableLayout&&(v=h.slides.offsetWidth,b=h.slides.offsetHeight);const w={width:v,height:b,presentationWidth:l||h.wrapper.offsetWidth,presentationHeight:m||h.wrapper.offsetHeight};return w.presentationWidth-=w.presentationWidth*r.margin,w.presentationHeight-=w.presentationHeight*r.margin,typeof w.width=="string"&&/%$/.test(w.width)&&(w.width=parseInt(w.width,10)/100*w.presentationWidth),typeof w.height=="string"&&/%$/.test(w.height)&&(w.height=parseInt(w.height,10)/100*w.presentationHeight),w}function de(l,m){typeof l=="object"&&typeof l.setAttribute=="function"&&l.setAttribute("data-previous-indexv",m||0)}function he(l){if(typeof l=="object"&&typeof l.setAttribute=="function"&&l.classList.contains("stack")){const m=l.hasAttribute("data-start-indexv")?"data-start-indexv":"data-previous-indexv";return parseInt(l.getAttribute(m)||0,10)}return 0}function wt(l=a){return l&&l.parentNode&&!!l.parentNode.nodeName.match(/section/i)}function ue(){return!(!a||!wt(a))&&!a.nextElementSibling}function pe(){return n===0&&i===0}function qt(){return!!a&&!a.nextElementSibling&&(!wt(a)||!a.parentNode.nextElementSibling)}function ge(){if(r.pause){const l=h.wrapper.classList.contains("paused");Rt(),h.wrapper.classList.add("paused"),l===!1&&Q({type:"paused"})}}function kt(){const l=h.wrapper.classList.contains("paused");h.wrapper.classList.remove("paused"),ft(),l&&Q({type:"resumed"})}function me(l){typeof l=="boolean"?l?ge():kt():St()?kt():ge()}function St(){return h.wrapper.classList.contains("paused")}function et(l,m,v,b){if(Q({type:"beforeslidechange",data:{indexh:l===void 0?n:l,indexv:m===void 0?i:m,origin:b}}).defaultPrevented)return;s=a;const w=h.wrapper.querySelectorAll(rt);if(f.isActive()){const Z=f.getSlideByIndices(l,m);return void(Z&&f.scrollToSlide(Z))}if(w.length===0)return;m!==void 0||$.isActive()||(m=he(w[l])),s&&s.parentNode&&s.parentNode.classList.contains("stack")&&de(s.parentNode,i);const I=g.concat();g.length=0;let z=n||0,H=i||0;n=ve(rt,l===void 0?n:l),i=ve(Be,m===void 0?i:m);let st=n!==z||i!==H;st||(s=null);let ut=w[n],Y=ut.querySelectorAll("section");c.classList.toggle("is-vertical-slide",Y.length>1),a=Y[i]||ut;let _=!1;st&&s&&a&&!$.isActive()&&(D="running",_=Ot(s,a,z,H),_&&h.slides.classList.add("disable-slide-transitions")),Ut(),mt(),$.isActive()&&$.update(),v!==void 0&&P.goto(v),s&&s!==a&&(s.classList.remove("present"),s.setAttribute("aria-hidden","true"),pe()&&setTimeout((()=>{E(h.wrapper,rt+".stack").forEach((Z=>{de(Z,0)}))}),0));t:for(let Z=0,cn=g.length;Z<cn;Z++){for(let Nt=0;Nt<I.length;Nt++)if(I[Nt]===g[Z]){I.splice(Nt,1);continue t}h.viewport.classList.add(g[Z]),Q({type:g[Z]})}for(;I.length;)h.viewport.classList.remove(I.pop());st&&oe(b),!st&&s||(R.stopEmbeddedContent(s),R.startEmbeddedContent(a)),requestAnimationFrame((()=>{_t(Et(a))})),nt.update(),V.update(),G.update(),N.update(),N.updateParallax(),T.update(),P.update(),X.writeURL(),ft(),_&&(setTimeout((()=>{h.slides.classList.remove("disable-slide-transitions")}),0),r.autoAnimate&&U.run(s,a))}function Ot(l,m,v,b){return l.hasAttribute("data-auto-animate")&&m.hasAttribute("data-auto-animate")&&l.getAttribute("data-auto-animate-id")===m.getAttribute("data-auto-animate-id")&&!(n>v||i>b?m:l).hasAttribute("data-auto-animate-restart")}function fe(){xt(),se(),mt(),S=r.autoSlide,ft(),N.create(),X.writeURL(),r.sortFragmentsOnSync===!0&&P.sortAll(),V.update(),nt.update(),Ut(),G.update(),G.updateVisibility(),F.update(),N.update(!0),T.update(),R.formatEmbeddedContent(),r.autoPlayMedia===!1?R.stopEmbeddedContent(a,{unloadIframes:!1}):R.startEmbeddedContent(a),$.isActive()&&$.layout()}function Ft(l=at()){l.forEach(((m,v)=>{let b=l[Math.floor(Math.random()*l.length)];b.parentNode===m.parentNode&&m.parentNode.insertBefore(m,b);let w=m.querySelectorAll("section");w.length&&Ft(w)}))}function ve(l,m){let v=E(h.wrapper,l),b=v.length,w=f.isActive()||C.isActive(),I=!1,z=!1;if(b){r.loop&&(m>=b&&(I=!0),(m%=b)<0&&(m=b+m,z=!0)),m=Math.max(Math.min(m,b-1),0);for(let Y=0;Y<b;Y++){let _=v[Y],Z=r.rtl&&!wt(_);_.classList.remove("past"),_.classList.remove("present"),_.classList.remove("future"),_.setAttribute("hidden",""),_.setAttribute("aria-hidden","true"),_.querySelector("section")&&_.classList.add("stack"),w?_.classList.add("present"):Y<m?(_.classList.add(Z?"future":"past"),r.fragments&&ye(_)):Y>m?(_.classList.add(Z?"past":"future"),r.fragments&&be(_)):Y===m&&r.fragments&&(I?be(_):z&&ye(_))}let H=v[m],st=H.classList.contains("present");H.classList.add("present"),H.removeAttribute("hidden"),H.removeAttribute("aria-hidden"),st||Q({target:H,type:"visible",bubbles:!1});let ut=H.getAttribute("data-state");ut&&(g=g.concat(ut.split(" ")))}else m=0;return m}function ye(l){E(l,".fragment").forEach((m=>{m.classList.add("visible"),m.classList.remove("current-fragment")}))}function be(l){E(l,".fragment.visible").forEach((m=>{m.classList.remove("visible","current-fragment")}))}function Ut(){let l,m,v=at(),b=v.length;if(b&&n!==void 0){let w=$.isActive()?10:r.viewDistance;bt&&(w=$.isActive()?6:r.mobileViewDistance),C.isActive()&&(w=Number.MAX_VALUE);for(let I=0;I<b;I++){let z=v[I],H=E(z,"section"),st=H.length;if(l=Math.abs((n||0)-I)||0,r.loop&&(l=Math.abs(((n||0)-I)%(b-w))||0),l<w?R.load(z):R.unload(z),st){let ut=he(z);for(let Y=0;Y<st;Y++){let _=H[Y];m=Math.abs(I===(n||0)?(i||0)-Y:Y-ut),l+m<w?R.load(_):R.unload(_)}}}xe()?h.wrapper.classList.add("has-vertical-slides"):h.wrapper.classList.remove("has-vertical-slides"),Ee()?h.wrapper.classList.add("has-horizontal-slides"):h.wrapper.classList.remove("has-horizontal-slides")}}function it({includeFragments:l=!1}={}){let m=h.wrapper.querySelectorAll(rt),v=h.wrapper.querySelectorAll(Be),b={left:n>0,right:n<m.length-1,up:i>0,down:i<v.length-1};if(r.loop&&(m.length>1&&(b.left=!0,b.right=!0),v.length>1&&(b.up=!0,b.down=!0)),m.length>1&&r.navigationMode==="linear"&&(b.right=b.right||b.down,b.left=b.left||b.up),l===!0){let w=P.availableRoutes();b.left=b.left||w.prev,b.up=b.up||w.prev,b.down=b.down||w.next,b.right=b.right||w.next}if(r.rtl){let w=b.left;b.left=b.right,b.right=w}return b}function we(l=a){let m=at(),v=0;t:for(let b=0;b<m.length;b++){let w=m[b],I=w.querySelectorAll("section");for(let z=0;z<I.length;z++){if(I[z]===l)break t;I[z].dataset.visibility!=="uncounted"&&v++}if(w===l)break;w.classList.contains("stack")===!1&&w.dataset.visibility!=="uncounted"&&v++}return v}function ke(l){let m,v=n,b=i;if(l)if(f.isActive())v=parseInt(l.getAttribute("data-index-h"),10),l.getAttribute("data-index-v")&&(b=parseInt(l.getAttribute("data-index-v"),10));else{let w=wt(l),I=w?l.parentNode:l,z=at();v=Math.max(z.indexOf(I),0),b=void 0,w&&(b=Math.max(E(l.parentNode,"section").indexOf(l),0))}if(!l&&a&&a.querySelectorAll(".fragment").length>0){let w=a.querySelector(".current-fragment");m=w&&w.hasAttribute("data-fragment-index")?parseInt(w.getAttribute("data-fragment-index"),10):a.querySelectorAll(".fragment.visible").length-1}return{h:v,v:b,f:m}}function Vt(){return E(h.wrapper,pt+':not(.stack):not([data-visibility="uncounted"])')}function at(){return E(h.wrapper,rt)}function Se(){return E(h.wrapper,".slides>section>section")}function Ee(){return at().length>1}function xe(){return Se().length>1}function Ae(){return Vt().length}function Re(l,m){let v=at()[l],b=v&&v.querySelectorAll("section");return b&&b.length&&typeof m=="number"?b?b[m]:void 0:v}function Le(){let l=ke();return{indexh:l.h,indexv:l.v,indexf:l.f,paused:St(),overview:$.isActive(),...F.getState()}}function ft(){if(Rt(),a&&r.autoSlide!==!1){let l=a.querySelector(".current-fragment[data-autoslide]"),m=l?l.getAttribute("data-autoslide"):null,v=a.parentNode?a.parentNode.getAttribute("data-autoslide"):null,b=a.getAttribute("data-autoslide");m?S=parseInt(m,10):b?S=parseInt(b,10):v?S=parseInt(v,10):(S=r.autoSlide,a.querySelectorAll(".fragment").length===0&&E(a,"video, audio").forEach((w=>{w.hasAttribute("data-autoplay")&&S&&1e3*w.duration/w.playbackRate>S&&(S=1e3*w.duration/w.playbackRate+1e3)}))),!S||M||St()||$.isActive()||qt()&&!P.availableRoutes().next&&r.loop!==!0||(q=setTimeout((()=>{typeof r.autoSlideMethod=="function"?r.autoSlideMethod():Kt(),ft()}),S),J=Date.now()),o&&o.setPlaying(q!==-1)}}function Rt(){clearTimeout(q),q=-1}function Lt(){S&&!M&&(M=!0,Q({type:"autoslidepaused"}),clearTimeout(q),o&&o.setPlaying(!1))}function Tt(){S&&M&&(M=!1,Q({type:"autoslideresumed"}),ft())}function Ct({skipFragments:l=!1}={}){if(d.hasNavigatedHorizontally=!0,f.isActive())return f.prev();r.rtl?($.isActive()||l||P.next()===!1)&&it().left&&et(n+1,r.navigationMode==="grid"?i:void 0):($.isActive()||l||P.prev()===!1)&&it().left&&et(n-1,r.navigationMode==="grid"?i:void 0)}function Pt({skipFragments:l=!1}={}){if(d.hasNavigatedHorizontally=!0,f.isActive())return f.next();r.rtl?($.isActive()||l||P.prev()===!1)&&it().right&&et(n-1,r.navigationMode==="grid"?i:void 0):($.isActive()||l||P.next()===!1)&&it().right&&et(n+1,r.navigationMode==="grid"?i:void 0)}function Wt({skipFragments:l=!1}={}){if(f.isActive())return f.prev();($.isActive()||l||P.prev()===!1)&&it().up&&et(n,i-1)}function jt({skipFragments:l=!1}={}){if(d.hasNavigatedVertically=!0,f.isActive())return f.next();($.isActive()||l||P.next()===!1)&&it().down&&et(n,i+1)}function Te({skipFragments:l=!1}={}){if(f.isActive())return f.prev();if(l||P.prev()===!1)if(it().up)Wt({skipFragments:l});else{let m;if(m=r.rtl?E(h.wrapper,rt+".future").pop():E(h.wrapper,rt+".past").pop(),m&&m.classList.contains("stack")){let v=m.querySelectorAll("section").length-1||void 0;et(n-1,v)}else r.rtl?Pt({skipFragments:l}):Ct({skipFragments:l})}}function Kt({skipFragments:l=!1}={}){if(d.hasNavigatedHorizontally=!0,d.hasNavigatedVertically=!0,f.isActive())return f.next();if(l||P.next()===!1){let m=it();m.down&&m.right&&r.loop&&ue()&&(m.down=!1),m.down?jt({skipFragments:l}):r.rtl?Ct({skipFragments:l}):Pt({skipFragments:l})}}function Ce(l){let m=l.data;if(typeof m=="string"&&m.charAt(0)==="{"&&m.charAt(m.length-1)==="}"&&(m=JSON.parse(m),m.method&&typeof e[m.method]=="function"))if(pn.test(m.method)===!1){const v=e[m.method].apply(e,m.args);le("callback",{method:m.method,result:v})}else console.warn('reveal.js: "'+m.method+'" is is blacklisted from the postMessage API')}function Pe(l){D==="running"&&/section/gi.test(l.target.nodeName)&&(D="idle",Q({type:"slidetransitionend",data:{indexh:n,indexv:i,previousSlide:s,currentSlide:a}}))}function Ie(l){const m=W(l.target,'a[href^="#"]');if(m){const v=m.getAttribute("href"),b=X.getIndicesFromHash(v);b&&(e.slide(b.h,b.v,b.f),l.preventDefault())}}function Ne(l){mt()}function Me(l){document.hidden===!1&&document.activeElement!==document.body&&(typeof document.activeElement.blur=="function"&&document.activeElement.blur(),document.body.focus())}function It(l){(document.fullscreenElement||document.webkitFullscreenElement)===h.wrapper&&(l.stopImmediatePropagation(),setTimeout((()=>{e.layout(),e.focus.focus()}),1))}function ln(l){qt()&&r.loop===!1?(et(0,0),Tt()):M?Tt():Lt()}const ze={VERSION:Ze,initialize:function(l){if(!c)throw'Unable to find presentation root (<div class="reveal">).';if(p)throw"Reveal.js has already been initialized.";if(p=!0,h.wrapper=c,h.slides=c.querySelector(".slides"),!h.slides)throw'Unable to find slides container (<div class="slides">).';return r={...Mn,...r,...t,...l,...$e()},/print-pdf/gi.test(window.location.search)&&(r.view="print"),(function(){r.embedded===!0?h.viewport=W(c,".reveal-viewport")||c:(h.viewport=document.body,document.documentElement.classList.add("reveal-full-page")),h.viewport.classList.add("reveal-viewport")})(),window.addEventListener("load",mt,!1),tt.load(r.plugins,r.dependencies).then(on),new Promise((m=>e.on("ready",m)))},configure:ie,destroy:function(){p=!1,u!==!1&&(xt(),Rt(),G.destroy(),ht.destroy(),F.destroy(),tt.destroy(),ne.destroy(),V.destroy(),nt.destroy(),N.destroy(),T.destroy(),O.destroy(),document.removeEventListener("fullscreenchange",It),document.removeEventListener("webkitfullscreenchange",It),document.removeEventListener("visibilitychange",Me,!1),window.removeEventListener("message",Ce,!1),window.removeEventListener("load",mt,!1),h.pauseOverlay&&h.pauseOverlay.remove(),h.statusElement&&h.statusElement.remove(),document.documentElement.classList.remove("reveal-full-page"),h.wrapper.classList.remove("ready","center","has-horizontal-slides","has-vertical-slides"),h.wrapper.removeAttribute("data-transition-speed"),h.wrapper.removeAttribute("data-background-transition"),h.viewport.classList.remove("reveal-viewport"),h.viewport.style.removeProperty("--slide-width"),h.viewport.style.removeProperty("--slide-height"),h.slides.style.removeProperty("width"),h.slides.style.removeProperty("height"),h.slides.style.removeProperty("zoom"),h.slides.style.removeProperty("left"),h.slides.style.removeProperty("top"),h.slides.style.removeProperty("bottom"),h.slides.style.removeProperty("right"),h.slides.style.removeProperty("transform"),Array.from(h.wrapper.querySelectorAll(pt)).forEach((l=>{l.style.removeProperty("display"),l.style.removeProperty("top"),l.removeAttribute("hidden"),l.removeAttribute("aria-hidden")})))},sync:fe,syncSlide:function(l=a){N.sync(l),P.sync(l),R.load(l),N.update(),G.update()},syncFragments:P.sync.bind(P),slide:et,left:Ct,right:Pt,up:Wt,down:jt,prev:Te,next:Kt,navigateLeft:Ct,navigateRight:Pt,navigateUp:Wt,navigateDown:jt,navigatePrev:Te,navigateNext:Kt,navigateFragment:P.goto.bind(P),prevFragment:P.prev.bind(P),nextFragment:P.next.bind(P),on:ae,off:re,addEventListener:ae,removeEventListener:re,layout:mt,shuffle:Ft,availableRoutes:it,availableFragments:P.availableRoutes.bind(P),toggleHelp:F.toggleHelp.bind(F),toggleOverview:$.toggle.bind($),toggleScrollView:f.toggle.bind(f),togglePause:me,toggleAutoSlide:function(l){typeof l=="boolean"?l?Tt():Lt():M?Tt():Lt()},toggleJumpToSlide:function(l){typeof l=="boolean"?l?O.show():O.hide():O.isVisible()?O.hide():O.show()},isFirstSlide:pe,isLastSlide:qt,isLastVerticalSlide:ue,isVerticalSlide:wt,isVerticalStack:function(l=a){return l.classList.contains(".stack")||l.querySelector("section")!==null},isPaused:St,isAutoSliding:function(){return!(!S||M)},isSpeakerNotes:G.isSpeakerNotesWindow.bind(G),isOverview:$.isActive.bind($),isFocused:ht.isFocused.bind(ht),isOverlayOpen:F.isOpen.bind(F),isScrollView:f.isActive.bind(f),isPrintView:C.isActive.bind(C),isReady:()=>u,loadSlide:R.load.bind(R),unloadSlide:R.unload.bind(R),startEmbeddedContent:()=>R.startEmbeddedContent(a),stopEmbeddedContent:()=>R.stopEmbeddedContent(a,{unloadIframes:!1}),previewIframe:F.previewIframe.bind(F),previewImage:F.previewImage.bind(F),previewVideo:F.previewVideo.bind(F),showPreview:F.previewIframe.bind(F),hidePreview:F.close.bind(F),addEventListeners:se,removeEventListeners:xt,dispatchEvent:Q,getState:Le,setState:function(l){if(typeof l=="object"){et(vt(l.indexh),vt(l.indexv),vt(l.indexf));let m=vt(l.paused),v=vt(l.overview);typeof m=="boolean"&&m!==St()&&me(m),typeof v=="boolean"&&v!==$.isActive()&&$.toggle(v),F.setState(l)}},getProgress:function(){let l=Ae(),m=we();if(a){let v=a.querySelectorAll(".fragment");v.length>0&&(m+=a.querySelectorAll(".fragment.visible").length/v.length*.9)}return Math.min(m/(l-1),1)},getIndices:ke,getSlidesAttributes:function(){return Vt().map((l=>{let m={};for(let v=0;v<l.attributes.length;v++){let b=l.attributes[v];m[b.name]=b.value}return m}))},getSlidePastCount:we,getTotalSlides:Ae,getSlide:Re,getPreviousSlide:()=>s,getCurrentSlide:()=>a,getSlideBackground:function(l,m){let v=typeof l=="number"?Re(l,m):l;if(v)return v.slideBackgroundElement},getSlideNotes:G.getSlideNotes.bind(G),getSlides:Vt,getHorizontalSlides:at,getVerticalSlides:Se,hasHorizontalSlides:Ee,hasVerticalSlides:xe,hasNavigatedHorizontally:()=>d.hasNavigatedHorizontally,hasNavigatedVertically:()=>d.hasNavigatedVertically,shouldAutoAnimateBetween:Ot,addKeyBinding:K.addKeyBinding.bind(K),removeKeyBinding:K.removeKeyBinding.bind(K),triggerKey:K.triggerKey.bind(K),registerKeyboardShortcut:K.registerKeyboardShortcut.bind(K),getComputedSlideSize:At,setCurrentScrollPage:function(l,m,v){let b=n||0;n=m,i=v;const w=a!==l;s=a,a=l,a&&s&&r.autoAnimate&&Ot(s,a,b,i)&&U.run(s,a),w&&(s&&(R.stopEmbeddedContent(s),R.stopEmbeddedContent(s.slideBackgroundElement)),R.startEmbeddedContent(a),R.startEmbeddedContent(a.slideBackgroundElement)),requestAnimationFrame((()=>{_t(Et(a))})),oe()},getScale:()=>y,getConfig:()=>r,getQueryHash:$e,getSlidePath:X.getHash.bind(X),getRevealElement:()=>c,getSlidesElement:()=>h.slides,getViewportElement:()=>h.viewport,getBackgroundsElement:()=>N.element,registerPlugin:tt.registerPlugin.bind(tt),hasPlugin:tt.hasPlugin.bind(tt),getPlugin:tt.getPlugin.bind(tt),getPlugins:tt.getRegisteredPlugins.bind(tt)};return yt(e,{...ze,announceStatus:_t,getStatusText:Et,focus:ht,scroll:f,progress:nt,controls:V,location:X,overview:$,keyboard:K,fragments:P,backgrounds:N,slideContent:R,slideNumber:T,onUserInput:function(l){r.autoSlideStoppable&&Lt()},closeOverlay:F.close.bind(F),updateSlidesVisibility:Ut,layoutSlideContents:ce,transformSlides:Dt,cueAutoSlide:ft,cancelAutoSlide:Rt}),ze}let ot=Qe,qe=[];ot.initialize=c=>(Object.assign(ot,new Qe(document.querySelector(".reveal"),c)),qe.map((t=>t(ot))),ot.initialize()),["configure","on","off","addEventListener","removeEventListener","registerPlugin"].forEach((c=>{ot[c]=(...t)=>{qe.push((e=>e[c].call(null,...t)))}})),ot.isReady=()=>!1,ot.VERSION=Ze;function zn(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let gt={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const Ge=/[&<>"']/,$n=new RegExp(Ge.source,"g"),tn=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Bn=new RegExp(tn.source,"g"),Hn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Oe=c=>Hn[c];function j(c,t){if(t){if(Ge.test(c))return c.replace($n,Oe)}else if(tn.test(c))return c.replace(Bn,Oe);return c}const _n=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function en(c){return c.replace(_n,((t,e)=>(e=e.toLowerCase())==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const Dn=/(^|[^\[])\^/g;function B(c,t){c=typeof c=="string"?c:c.source,t=t||"";const e={replace:(n,i)=>(i=(i=i.source||i).replace(Dn,"$1"),c=c.replace(n,i),e),getRegex:()=>new RegExp(c,t)};return e}const qn=/[^\w:]/g,On=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Fe(c,t,e){if(c){let n;try{n=decodeURIComponent(en(e)).replace(qn,"").toLowerCase()}catch{return null}if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}t&&!On.test(e)&&(e=(function(n,i){Mt[" "+n]||(Fn.test(n)?Mt[" "+n]=n+"/":Mt[" "+n]=zt(n,"/",!0)),n=Mt[" "+n];const s=n.indexOf(":")===-1;return i.substring(0,2)==="//"?s?i:n.replace(Un,"$1")+i:i.charAt(0)==="/"?s?i:n.replace(Vn,"$1")+i:n+i})(t,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch{return null}return e}const Mt={},Fn=/^[^:]+:\/*[^/]*$/,Un=/^([^:]+:)[\s\S]*$/,Vn=/^([^:]+:\/*[^/]*)[\s\S]*$/,Bt={exec:function(){}};function Ue(c,t){const e=c.replace(/\|/g,((i,s,a)=>{let o=!1,r=s;for(;--r>=0&&a[r]==="\\";)o=!o;return o?"|":" |"})).split(/ \|/);let n=0;if(e[0].trim()||e.shift(),e.length>0&&!e[e.length-1].trim()&&e.pop(),e.length>t)e.splice(t);else for(;e.length<t;)e.push("");for(;n<e.length;n++)e[n]=e[n].trim().replace(/\\\|/g,"|");return e}function zt(c,t,e){const n=c.length;if(n===0)return"";let i=0;for(;i<n;){const s=c.charAt(n-i-1);if(s!==t||e){if(s===t||!e)break;i++}else i++}return c.slice(0,n-i)}function Ve(c,t){if(t<1)return"";let e="";for(;t>1;)1&t&&(e+=c),t>>=1,c+=c;return e+c}function We(c,t,e,n){const i=t.href,s=t.title?j(t.title):null,a=c[1].replace(/\\([\[\]])/g,"$1");if(c[0].charAt(0)!=="!"){n.state.inLink=!0;const o={type:"link",raw:e,href:i,title:s,text:a,tokens:n.inlineTokens(a)};return n.state.inLink=!1,o}return{type:"image",raw:e,href:i,title:s,text:j(a)}}class Gt{constructor(t){this.options=t||gt}space(t){const e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){const e=this.rules.block.code.exec(t);if(e){const n=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?n:zt(n,`
...
`+n.raw,i.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=i.text):e.push(n);else if(t){const o="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(o);break}throw new Error(o)}}return this.state.top=!0,e}inline(t,e=[]){return this.inlineQueue.push({src:t,tokens:e}),e}inlineTokens(t,e=[]){let n,i,s,a,o,r,p=t;if(this.tokens.links){const u=Object.keys(this.tokens.links);if(u.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(p))!=null;)u.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(p=p.slice(0,a.index)+"["+Ve("a",a[0].length-2)+"]"+p.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.blockSkip.exec(p))!=null;)p=p.slice(0,a.index)+"["+Ve("a",a[0].length-2)+"]"+p.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(a=this.tokenizer.rules.inline.escapedEmSt.exec(p))!=null;)p=p.slice(0,a.index+a[0].length-2)+"++"+p.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;t;)if(o||(r=""),o=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some((u=>!!(n=u.call({lexer:this},t,e))&&(t=t.substring(n.raw.length),e.push(n),!0)))))if(n=this.tokenizer.escape(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.tag(t))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.link(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.reflink(t,this.tokens.links))t=t.substring(n.raw.length),i=e[e.length-1],i&&n.type==="text"&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(n=this.tokenizer.emStrong(t,p,r))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.codespan(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.br(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.del(t))t=t.substring(n.raw.length),e.push(n);else if(n=this.tokenizer.autolink(t,je))t=t.substring(n.raw.length),e.push(n);else if(this.state.inLink||!(n=this.tokenizer.url(t,je))){if(s=t,this.options.extensions&&this.options.extensions.startInline){let u=1/0;const d=t.slice(1);let g;this.options.extensions.startInline.forEach((function(y){g=y.call({lexer:this},d),typeof g=="number"&&g>=0&&(u=Math.min(u,g))})),u<1/0&&u>=0&&(s=t.substring(0,u+1))}if(n=this.tokenizer.inlineText(s,Wn))t=t.substring(n.raw.length),n.raw.slice(-1)!=="_"&&(r=n.raw.slice(-1)),o=!0,i=e[e.length-1],i&&i.type==="text"?(i.raw+=n.raw,i.text+=n.text):e.push(n);else if(t){const u="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(u);break}throw new Error(u)}}else t=t.substring(n.raw.length),e.push(n);return e}}class te{constructor(t){this.options=t||gt}code(t,e,n){const i=(e||"").match(/\S*/)[0];if(this.options.highlight){const s=this.options.highlight(t,i);s!=null&&s!==t&&(n=!0,t=s)}return t=t.replace(/\n$/,"")+`
...
`}strong(t){return`<strong>${t}</strong>`}em(t){return`<em>${t}</em>`}codespan(t){return`<code>${t}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(t){return`<del>${t}</del>`}link(t,e,n){if((t=Fe(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i='<a href="'+t+'"';return e&&(i+=' title="'+e+'"'),i+=">"+n+"</a>",i}image(t,e,n){if((t=Fe(this.options.sanitize,this.options.baseUrl,t))===null)return n;let i=`<img src="${t}" alt="${n}"`;return e&&(i+=` title="${e}"`),i+=this.options.xhtml?"/>":">",i}text(t){return t}}class nn{strong(t){return t}em(t){return t}codespan(t){return t}del(t){return t}html(t){return t}text(t){return t}link(t,e,n){return""+n}image(t,e,n){return""+n}br(){return""}}class sn{constructor(){this.seen={}}serialize(t){return t.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(t,e){let n=t,i=0;if(this.seen.hasOwnProperty(n)){i=this.seen[t];do i++,n=t+"-"+i;while(this.seen.hasOwnProperty(n))}return e||(this.seen[t]=i,this.seen[n]=0),n}slug(t,e={}){const n=this.serialize(t);return this.getNextSafeSlug(n,e.dryrun)}}class dt{constructor(t){this.options=t||gt,this.options.renderer=this.options.renderer||new te,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new nn,this.slugger=new sn}static parse(t,e){return new dt(e).parse(t)}static parseInline(t,e){return new dt(e).parseInline(t)}parse(t,e=!0){let n,i,s,a,o,r,p,u,d,g,y,L,h,D,S,q,J,M,R,T="";const O=t.length;for(n=0;n<O;n++)if(g=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[g.type]&&(R=this.options.extensions.renderers[g.type].call({parser:this},g),R!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(g.type)))T+=R||"";else switch(g.type){case"space":continue;case"hr":T+=this.renderer.hr();continue;case"heading":T+=this.renderer.heading(this.parseInline(g.tokens),g.depth,en(this.parseInline(g.tokens,this.textRenderer)),this.slugger);continue;case"code":T+=this.renderer.code(g.text,g.lang,g.escaped);continue;case"table":for(u="",p="",a=g.header.length,i=0;i<a;i++)p+=this.renderer.tablecell(this.parseInline(g.header[i].tokens),{header:!0,align:g.align[i]});for(u+=this.renderer.tablerow(p),d="",a=g.rows.length,i=0;i<a;i++){for(r=g.rows[i],p="",o=r.length,s=0;s<o;s++)p+=this.renderer.tablecell(this.parseInline(r[s].tokens),{header:!1,align:g.align[s]});d+=this.renderer.tablerow(p)}T+=this.renderer.table(u,d);continue;case"blockquote":d=this.parse(g.tokens),T+=this.renderer.blockquote(d);continue;case"list":for(y=g.ordered,L=g.start,h=g.loose,a=g.items.length,d="",i=0;i<a;i++)S=g.items[i],q=S.checked,J=S.task,D="",S.task&&(M=this.renderer.checkbox(q),h?S.tokens.length>0&&S.tokens[0].type==="paragraph"?(S.tokens[0].text=M+" "+S.tokens[0].text,S.tokens[0].tokens&&S.tokens[0].tokens.length>0&&S.tokens[0].tokens[0].type==="text"&&(S.tokens[0].tokens[0].text=M+" "+S.tokens[0].tokens[0].text)):S.tokens.unshift({type:"text",text:M}):D+=M),D+=this.parse(S.tokens,h),d+=this.renderer.listitem(D,J,q);T+=this.renderer.list(d,y,L);continue;case"html":T+=this.renderer.html(g.text);continue;case"paragraph":T+=this.renderer.paragraph(this.parseInline(g.tokens));continue;case"text":for(d=g.tokens?this.parseInline(g.tokens):g.text;n+1<O&&t[n+1].type==="text";)g=t[++n],d+=`
`+(g.tokens?this.parseInline(g.tokens):g.text);T+=e?this.renderer.paragraph(d):d;continue;default:{const U='Token with "'+g.type+'" type was not found.';if(this.options.silent)return void console.error(U);throw new Error(U)}}return T}parseInline(t,e){e=e||this.renderer;let n,i,s,a="";const o=t.length;for(n=0;n<o;n++)if(i=t[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]&&(s=this.options.extensions.renderers[i.type].call({parser:this},i),s!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)))a+=s||"";else switch(i.type){case"escape":case"text":a+=e.text(i.text);break;case"html":a+=e.html(i.text);break;case"link":a+=e.link(i.href,i.title,this.parseInline(i.tokens,e));break;case"image":a+=e.image(i.href,i.title,i.text);break;case"strong":a+=e.strong(this.parseInline(i.tokens,e));break;case"em":a+=e.em(this.parseInline(i.tokens,e));break;case"codespan":a+=e.codespan(i.text);break;case"br":a+=e.br();break;case"del":a+=e.del(this.parseInline(i.tokens,e));break;default:{const r='Token with "'+i.type+'" type was not found.';if(this.options.silent)return void console.error(r);throw new Error(r)}}return a}}class Zt{constructor(t){this.options=t||gt}static passThroughHooks=new Set(["preprocess","postprocess"]);preprocess(t){return t}postprocess(t){return t}}function an(c,t){return(e,n,i)=>{typeof n=="function"&&(i=n,n=null);const s={...n},a=(function(o,r,p){return u=>{if(u.message+=`
Please report this to https://github.com/markedjs/marked.`,o){const d="<p>An error occurred:</p><pre>"+j(u.message+"",!0)+"</pre>";return r?Promise.resolve(d):p?void p(null,d):d}if(r)return Promise.reject(u);if(!p)throw u;p(u)}})((n={...x.defaults,...s}).silent,n.async,i);if(e==null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if((function(o){o&&o.sanitize&&!o.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")})(n),n.hooks&&(n.hooks.options=n),i){const o=n.highlight;let r;try{n.hooks&&(e=n.hooks.preprocess(e)),r=c(e,n)}catch(d){return a(d)}const p=function(d){let g;if(!d)try{n.walkTokens&&x.walkTokens(r,n.walkTokens),g=t(r,n),n.hooks&&(g=n.hooks.postprocess(g))}catch(y){d=y}return n.highlight=o,d?a(d):i(null,g)};if(!o||o.length<3||(delete n.highlight,!r.length))return p();let u=0;return x.walkTokens(r,(function(d){d.type==="code"&&(u++,setTimeout((()=>{o(d.text,d.lang,(function(g,y){if(g)return p(g);y!=null&&y!==d.text&&(d.text=y,d.escaped=!0),u--,u===0&&p()}))}),0))})),void(u===0&&p())}if(n.async)return Promise.resolve(n.hooks?n.hooks.preprocess(e):e).then((o=>c(o,n))).then((o=>n.walkTokens?Promise.all(x.walkTokens(o,n.walkTokens)).then((()=>o)):o)).then((o=>t(o,n))).then((o=>n.hooks?n.hooks.postprocess(o):o)).catch(a);try{n.hooks&&(e=n.hooks.preprocess(e));const o=c(e,n);n.walkTokens&&x.walkTokens(o,n.walkTokens);let r=t(o,n);return n.hooks&&(r=n.hooks.postprocess(r)),r}catch(o){return a(o)}}}function x(c,t,e){return an(ct.lex,dt.parse)(c,t,e)}x.options=x.setOptions=function(c){var t;return x.defaults={...x.defaults,...c},t=x.defaults,gt=t,x},x.getDefaults=zn,x.defaults=gt,x.use=function(...c){const t=x.defaults.extensions||{renderers:{},childTokens:{}};c.forEach((e=>{const n={...e};if(n.async=x.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach((i=>{if(!i.name)throw new Error("extension name required");if(i.renderer){const s=t.renderers[i.name];t.renderers[i.name]=s?function(...a){let o=i.renderer.apply(this,a);return o===!1&&(o=s.apply(this,a)),o}:i.renderer}if(i.tokenizer){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");t[i.level]?t[i.level].unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]))}i.childTokens&&(t.childTokens[i.name]=i.childTokens)})),n.extensions=t),e.renderer){const i=x.defaults.renderer||new te;for(const s in e.renderer){const a=i[s];i[s]=(...o)=>{let r=e.renderer[s].apply(i,o);return r===!1&&(r=a.apply(i,o)),r}}n.renderer=i}if(e.tokenizer){const i=x.defaults.tokenizer||new Gt;for(const s in e.tokenizer){const a=i[s];i[s]=(...o)=>{let r=e.tokenizer[s].apply(i,o);return r===!1&&(r=a.apply(i,o)),r}}n.tokenizer=i}if(e.hooks){const i=x.defaults.hooks||new Zt;for(const s in e.hooks){const a=i[s];Zt.passThroughHooks.has(s)?i[s]=o=>{if(x.defaults.async)return Promise.resolve(e.hooks[s].call(i,o)).then((p=>a.call(i,p)));const r=e.hooks[s].call(i,o);return a.call(i,r)}:i[s]=(...o)=>{let r=e.hooks[s].apply(i,o);return r===!1&&(r=a.apply(i,o)),r}}n.hooks=i}if(e.walkTokens){const i=x.defaults.walkTokens;n.walkTokens=function(s){let a=[];return a.push(e.walkTokens.call(this,s)),i&&(a=a.concat(i.call(this,s))),a}}x.setOptions(n)}))},x.walkTokens=function(c,t){let e=[];for(const n of c)switch(e=e.concat(t.call(x,n)),n.type){case"table":for(const i of n.header)e=e.concat(x.walkTokens(i.tokens,t));for(const i of n.rows)for(const s of i)e=e.concat(x.walkTokens(s.tokens,t));break;case"list":e=e.concat(x.walkTokens(n.items,t));break;default:x.defaults.extensions&&x.defaults.extensions.childTokens&&x.defaults.extensions.childTokens[n.type]?x.defaults.extensions.childTokens[n.type].forEach((function(i){e=e.concat(x.walkTokens(n[i],t))})):n.tokens&&(e=e.concat(x.walkTokens(n.tokens,t)))}return e},x.parseInline=an(ct.lexInline,dt.parseInline),x.Parser=dt,x.parser=dt.parse,x.Renderer=te,x.TextRenderer=nn,x.Lexer=ct,x.lexer=ct.lex,x.Tokenizer=Gt,x.Slugger=sn,x.Hooks=Zt,x.parse=x,x.options,x.setOptions,x.use,x.walkTokens,x.parseInline,dt.parse,ct.lex;const jn=()=>{let c,t,e=null;function n(){if(e&&!e.closed)e.focus();else{if(e=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),e.marked=x,e.document.write(`<!--
...
</html>`),!e)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const o=t.getConfig().url,r=typeof o=="string"?o:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;c=setInterval((function(){e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:t.getState(),url:r}),"*")}),500),window.addEventListener("message",s)})()}}function i(o){let r=t.getCurrentSlide(),p=r.querySelectorAll("aside.notes"),u=r.querySelector(".current-fragment"),d={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:t.getState()};if(r.hasAttribute("data-notes")&&(d.notes=r.getAttribute("data-notes"),d.whitespace="pre-wrap"),u){let g=u.querySelector("aside.notes");g?(d.notes=g.innerHTML,d.markdown=typeof g.getAttribute("data-markdown")=="string",p=null):u.hasAttribute("data-notes")&&(d.notes=u.getAttribute("data-notes"),d.whitespace="pre-wrap",p=null)}p&&p.length&&(p=Array.from(p).filter((g=>g.closest(".fragment")===null)),d.notes=p.map((g=>g.innerHTML)).join(`
`),d.markdown=p[0]&&typeof p[0].getAttribute("data-markdown")=="string"),e.postMessage(JSON.stringify(d),"*")}function s(o){if((function(r){try{return window.location.origin===r.source.location.origin}catch{return!1}})(o))try{let r=JSON.parse(o.data);r&&r.namespace==="reveal-notes"&&r.type==="connected"?(clearInterval(c),a()):r&&r.namespace==="reveal-notes"&&r.type==="call"&&(function(p,u,d){let g=t[p].apply(t,u);e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:g,callId:d}),"*")})(r.methodName,r.arguments,r.callId)}catch{}}function a(){t.on("slidechanged",i),t.on("fragmentshown",i),t.on("fragmenthidden",i),t.on("overviewhidden",i),t.on("overviewshown",i),t.on("paused",i),t.on("resumed",i),t.on("previewiframe",i),t.on("previewimage",i),t.on("previewvideo",i),t.on("closeoverlay",i),i()}return{id:"notes",init:function(o){t=o,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?n():window.addEventListener("message",(r=>{if(!e&&typeof r.data=="string"){let u;try{u=JSON.parse(r.data)}catch{}u&&u.namespace==="reveal-notes"&&u.type==="heartbeat"&&(p=r.source,e&&!e.closed?e.focus():(e=p,window.addEventListener("message",s),a()))}var p})),t.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},(function(){n()})))},open:n}},ee=new ot({width:1600,height:900,margin:0,minScale:.2,maxScale:1.5,hash:!0,history:!0,controls:!0,controlsTutorial:!1,progress:!1,center:!1,transition:"fade",backgroundTransition:"fade",pdfSeparateFragments:!1,plugins:[jn]});function Ke(c,t,e=!1){const n=[...c.querySelectorAll("[data-switch-target]")],i=[...c.querySelectorAll('[role="tabpanel"]')],s=t.dataset.switchTarget;n.forEach(a=>{const o=a===t;a.setAttribute("aria-selected",String(o)),a.tabIndex=o?0:-1}),i.forEach(a=>{a.hidden=a.id!==s}),e&&t.focus()}function Kn(){document.querySelectorAll("[data-switcher]").forEach(c=>{const t=[...c.querySelectorAll("[data-switch-target]")];t.forEach((e,n)=>{e.addEventListener("click",i=>{i.stopPropagation(),Ke(c,e)}),e.addEventListener("keydown",i=>{if(!["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(i.key))return;i.preventDefault(),i.stopPropagation();let s=n;i.key==="Home"&&(s=0),i.key==="End"&&(s=t.length-1),(i.key==="ArrowLeft"||i.key==="ArrowUp")&&(s=(n-1+t.length)%t.length),(i.key==="ArrowRight"||i.key==="ArrowDown")&&(s=(n+1)%t.length),Ke(c,t[s],!0)})})}),document.querySelectorAll("[data-code-link]").forEach(c=>{c.addEventListener("click",t=>t.stopPropagation())})}function rn(c){document.querySelectorAll("[data-slide-video]").forEach(t=>{if(c?.contains(t)){t.readyState===0&&t.load(),t.currentTime=0,t.play().catch(()=>{});return}t.pause()})}Kn();ee.on("ready",c=>rn(c.currentSlide));ee.on("slidechanged",c=>rn(c.currentSlide));ee.initialize();
