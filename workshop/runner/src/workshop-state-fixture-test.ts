...
const session: WorkshopSession = {
	schemaVersion: "agent-native-harness-ladder/v2", ladderId: "ladder-fixture", stage: "started",
	createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", runs: {},
};
...
assert.match(nextAction("reference_complete"), /participant to choose/);
assert.match(nextAction("comparison_ready"), /limited claim/);
console.log("agent-native harness ladder state fixture tests passed");
